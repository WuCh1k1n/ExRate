...
public class ExrateAdapter extends ArrayAdapter {

    private int resourceId;

    public ExrateAdapter(@Nullable Context context, @Nullable int resource, @Nullable List objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.afterChange = (TextView) view.findViewById(R.id.tv_after_change);
        ...
        viewHolder.afterChange.setText(currency.getAfterChange()+"");
        return view;
    }
